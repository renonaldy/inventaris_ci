...
<head>
  ...
  <title>Sistem Infomasi Inventaris</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo base_url('admin')?>" class="logo">
      ...
      <span class="logo-mini"><b>H</b>ii</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Selamat Datang</span>
    </a>
            ...
            <?php } ?>
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" name="id_transaksi" style="margin-left:37px;width:20%;display:inline;" class="form-control" readonly="readonly" value="WG-<?=date("Y");?><?=random_string('numeric', 4);?>">
                </div>
                  <div class="form-group">
                  <label for="nama_peminjam" style="margin-left:220px;display:inline;">Nama Pemberi</label>
                  <input type="text" name="nama_peminjam" style="margin-left:22px;width:20%;display:inline;" class="form-control" id="nama_peminjam" placeholder="Masukkan nama lengkap">
              </div>
                <div class="form-group">
                ...
                <div class="form-group" style="margin-bottom:40px;">
                  <label for="nama_barang" style="margin-left:218px;display:inline;">Lokasi</label>
                  <select class="form-control" name="lokasi" style="margin-left:75px;width:20%;display:inline;">
                    <option value="">-- Pilih --</option>
                    <option value="kepsek">Ruang Kepala Sekolah</option>
                    ...
                    <option value="labortik">Labor TIK</option>
                    <option value="Labor Biologi">Labor Biologi</option>
                    <option value="Labor Kimia">Labor Kimia</option>
                    <option value="Medan Bapaneh">Medan Bapaneh</option>
                    <option value="Kelas Siswa">Kelas Siswa</option>
  ...
  <footer class="main-footer">
    ...
    <strong>Sistem Informasi Inventaris SMA Negeri 6 Padang - <?=date('Y')?></strong>
  </footer>
