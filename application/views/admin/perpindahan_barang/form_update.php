...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo base_url('admin')?>" class="logo">
      ...
      <span class="logo-lg"><b>Selamat</b>Datang</span>
    </a>
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="tanggal_keluar" style="margin-left:66px;width:20%;display:inline;" class="form-control form_datetime" required="" placeholder="Klik Disini">
                   ...
                   <div class="form-group">
                  <label for="nama_peminjam" style="margin-left:220px;display:inline;">Nama Pengambil</label>
                  <input type="text" name="nama_peminjam" style="margin-left:52px;width:20%;display:inline;" class="form-control" value="<?=$d->nama_peminjam?>">
                </div>
